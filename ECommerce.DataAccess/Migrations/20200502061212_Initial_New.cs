    ...
    public partial class Initial_New : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAuditTrails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryAuditTrails_EntityActionTypes_ActionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAuditTrails_EntityActionTypes_ActionTypeId",
                        column: x => x.ActionTypeId,
                        principalTable: "EntityActionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderActionId = table.Column<long>(nullable: false),
                    PerformedBy = table.Column<string>(nullable: true),
                    PerformedDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderAuditTrails_OrderActions_OrderActionId",
                        column: x => x.OrderActionId,
                        principalTable: "OrderActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAuditTrails_ActionTypeId",
                table: "CategoryAuditTrails",
                column: "ActionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderAuditTrails_OrderActionId",
                table: "OrderAuditTrails",
                column: "OrderActionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAuditTrails_ActionTypeId",
